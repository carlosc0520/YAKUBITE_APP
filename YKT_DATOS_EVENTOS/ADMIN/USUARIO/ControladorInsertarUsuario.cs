...
{
    public class ControladorInsertarUsuario : IRequestHandler<ComandoInsertarUsuario, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorInsertarUsuario(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoInsertarUsuario entidad, CancellationToken cancellationToken)
        {
