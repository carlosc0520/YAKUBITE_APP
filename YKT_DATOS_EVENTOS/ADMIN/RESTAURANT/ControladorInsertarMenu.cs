...
{
    public class ControladorInsertarMenu : IRequestHandler<ComandoInsertarMenu, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorInsertarMenu(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoInsertarMenu entidad, CancellationToken cancellationToken)
        {
